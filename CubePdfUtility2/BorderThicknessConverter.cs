    ...
    class BorderThicknessConverter : IMultiValueConverter
    {
        ...
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            try
            {
                ...
                var itemWidth = (double)values[0];
                var viewItemWidth = (double)values[1];
                var itemHeight = (double)values[2];
                var viewItemHeight = (double)values[3];
                double ratioW = itemWidth / viewItemWidth;
                double ratioH = itemHeight / viewItemHeight;
                return new System.Windows.Thickness(ratioW > ratioH ? ratioW : ratioH);
            }
